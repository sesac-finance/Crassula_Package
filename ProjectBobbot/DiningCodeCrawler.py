...
def dc_crawler(area, page):
    """
    검색할 지역(area)과 페이지 수(page)를 입력받아 다이닝코드 사이트를 크롤링하는 함수입니다.
    """
    ...
    if res.status_code == 200:
        print("서버가 요청한 " + page + "페이지를 성공적으로 제공했습니다.")
    else:
        print("서버로부터 요청한 " + page + "페이지를 받아오는 데 문제가 발생했습니다.")
        return ["error"]
    ...
    for restaurant in restaurant_list["result_data"]["poi_section"]["list"]:
        ...
        result_dict = {
            ...
            "분류": category,
            "점수": score,
            "링크": "https://www.diningcode.com/profile.php?rid=" + hyperlink
        }
    ...
    print(page + "페이지의 검색 결과에 대한 크롤링을 성공적으로 마쳤습니다.")
